...
var genesisStates_1 = require("@sbr/common/dist/genesisStates");
...
var DefaultStateManager = /** @class */ (function () {
    ...
    DefaultStateManager.prototype.putContractCode = function (address, value) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        codeHash = sbr_util_1.keccak256(value);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        balance = new sbr_util_1.BN(sbr_util_1.toBuffer(initState[address]));
                        account = sbr_util_1.Account.fromAccountData({ balance: balance });
                        addressBuffer = sbr_util_1.toBuffer(address);
    ...
    DefaultStateManager.prototype.generateAccessList = function (addressesRemoved, addressesOnlyStorage) {
        ...
        var mergedStorage = __spread(this._accessedStorage, this._accessedStorageReverted);
        ...
        var folded = new Map(__spread(mergedStorage[0].entries()).sort());
        // Transfer folded map to final structure
        var accessList = [];
        folded.forEach(function (slots, addressStr) {
            var address = sbr_util_1.Address.fromString("0x" + addressStr);
            var check1 = precompiles_1.getActivePrecompiles(_this._common).find(function (a) { return a.equals(address); });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        address = new sbr_util_1.Address(Buffer.from(addressHex, 'hex'));
