...
function runBlock(opts) {
    return __awaiter(this, void 0, void 0, function () {
        var state, root, block, generateFields, result, err_1, stateRoot, bloom, gasUsed, receiptTrie, transactionsTrie, generatedFields, blockData, results, afterBlockEvent;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!block.header.gasLimit.gte(new sbr_util_1.BN('8000000000000000', 16))) return [3 /*break*/, 1];
                    throw new Error('Invalid block with gas limit greater than (2^63 - 1)');
                case 1: return [4 /*yield*/, block.validate(this.blockchain)];
                case 2:
                    _a.sent();
                    _a.label = 3;
...
function applyTransactions(block, opts) {
    return __awaiter(this, void 0, void 0, function () {
        var bloom, gasUsed, receiptTrie, receipts, txResults, txIdx, tx, gasLimitIsHigherThanBlock, skipBalance, skipNonce, blockWithGasUsed, txRes, encodedReceipt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bloom = new bloom_1.default();
                    gasUsed = new sbr_util_1.BN(0);
                    receiptTrie = new sbr_merkle_patricia_tree_1.BaseTrie();
                    receipts = [];
                    txResults = [];
                    txIdx = 0;
                    _a.label = 1;
                case 1:
                    ...
                    blockWithGasUsed = block_1.Block.fromBlockData(__assign(__assign({}, block), { header: __assign(__assign({}, block.header), { gasUsed: gasUsed }) }), { common: this._common });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    state = this.stateManager;
                    minerReward = new sbr_util_1.BN(this._common.param('pow', 'minerReward'));
...
function calculateOmmerReward(ommerBlockNumber, blockNumber, minerReward) {
    ...
    var reward = new sbr_util_1.BN(8).sub(heightDiff).mul(minerReward.divn(8));
    if (reward.ltn(0)) {
...
function encodeReceipt(tx, receipt) {
    var encoded = rlp_1.encode(Object.values(receipt));
    if (!('transactionType' in tx) || tx.transactionType === 0) {
        return encoded;
    }
    var type = sbr_util_1.intToBuffer(tx.transactionType);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    receiptLog = "Generate tx receipt transactionType=" + ('transactionType' in tx ? tx.transactionType : 'NaN') + " gasUsed=" + blockGasUsed.toString() + " bitvector=" + opcodes_1.short(abstractTxReceipt.bitvector) + " (" + abstractTxReceipt.bitvector.length + " bytes) logs=" + abstractTxReceipt.logs.length;
...
function _applyDAOHardfork(state) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    DAORefundContractAddress = new sbr_util_1.Address(Buffer.from(DAORefundContract, 'hex'));
                    if (!!state.accountExists(DAORefundContractAddress)) return [3 /*break*/, 2];
                    return [4 /*yield*/, state.putAccount(DAORefundContractAddress, new sbr_util_1.Account())];
                case 1:
                    _b.sent();
                    _b.label = 2;
                ...
                case 5:
                    ...
                    address = new sbr_util_1.Address(Buffer.from(addr, 'hex'));
...
function _genTxTrie(block) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    trie = new sbr_merkle_patricia_tree_1.BaseTrie();
                    _e.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, trie.put(rlp_1.encode(i), tx.serialize())];
                case 3:
                    _e.sent();
                    _e.label = 4;
                case 4:
