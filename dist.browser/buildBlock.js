...
var BlockBuilder = /** @class */ (function () {
    function BlockBuilder(vm, opts) {
        ...
        this.built = false;
        this.vm = vm;
        this.blockOpts = __assign(__assign({}, opts.blockOpts), { common: this.vm._common });
     ...
     */
    BlockBuilder.prototype.bloom = function () {
        var e_2, _a;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        encodedReceipt = runBlock_1.encodeReceipt(tx, txResult.receipt);
                        return [4 /*yield*/, receiptTrie.put(rlp_1.encode(i), encodedReceipt)];
                    case 3:
                        _e.sent();
                        _e.label = 4;
                    case 4:
    ...
    BlockBuilder.prototype.rewardMiner = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        minerReward = new sbr_util_1.BN(this.vm._common.param('pow', 'minerReward'));
                        reward = runBlock_1.calculateMinerReward(minerReward, 0);
                        ...
                        return [4 /*yield*/, runBlock_1.rewardAccount(this.vm.stateManager, coinbase, reward)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        blockGasLimit = new sbr_util_1.BN(sbr_util_1.toBuffer(this.headerData.gasLimit));
    ...
    BlockBuilder.prototype.build = function (sealOpts) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var blockOpts, consensusType, stateRoot, transactionsTrie, receiptTrie, bloom, gasUsed, timestamp, headerData, blockData, block;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (!(consensusType === 'pow')) return [3 /*break*/, 2];
                    ...
                    case 5:
                        ...
                        headerData = __assign(__assign({}, this.headerData), { stateRoot: stateRoot,
                    ...
                    case 6:
                        _d.sent();
                        this.built = true;
                        if (!this.checkpointed) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.vm.stateManager.commit()];
                    case 7:
                        _d.sent();
                        this.checkpointed = false;
                        _d.label = 8;
                    case 8: return [2 /*return*/, block];
                }
            });
        });
    };
