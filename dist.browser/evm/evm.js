            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._state.getAccount(message.to || sbr_util_1.Address.zero())];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _a.label = 3;
                    case 3: return [2 /*return*/, new sbr_util_1.Address(addr)];
                }
            });
        });
    };
