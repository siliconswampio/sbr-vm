...
var EEI = /** @class */ (function () {
    ...
    EEI.prototype.useGas = function (amount, _context) {
     ...
     */
    // eslint-disable-next-line no-unused-vars
    EEI.prototype.refundGas = function (amount, _context) {
     ...
     */
    // eslint-disable-next-line no-unused-vars
    EEI.prototype.subRefund = function (amount, _context) {
    ...
    EEI.prototype.getExternalCodeSize = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        addr = new sbr_util_1.Address(addressToBuffer(address));
                        return [4 /*yield*/, this._state.getContractCode(addr)];
                    case 1:
                        code = _a.sent();
                        return [2 /*return*/, new sbr_util_1.BN(code.length)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        block = _a.sent();
                        return [2 /*return*/, new sbr_util_1.BN(block.hash())];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (this._env.depth >= this._common.param('vm', 'stackLimit') ||
                            ...
                            return [2 /*return*/, new sbr_util_1.BN(0)];
                        }
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (results.createdAddress) {
                            ...
                            return [2 /*return*/, new sbr_util_1.BN(results.createdAddress.buf)];
                        }
                        _a.label = 4;
