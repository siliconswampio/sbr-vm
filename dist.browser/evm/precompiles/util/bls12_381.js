...
var fieldModulus = new sbr_util_1.BN('1a0111ea397fe69a4b1ba7b6434bacd764774b84f38512bf6730d2a0f6b0f6241eabfffeb153ffffb9feffffffffaaab', 16);
...
function BLS12_381_FromG1Point(input) {
    ...
    // note: decoded[0] == 1
    var xval = sbr_util_1.padToEven(decoded[1]);
    var yval = sbr_util_1.padToEven(decoded[2]);
    // convert to buffers.
...
function BLS12_381_FromG2Point(input) {
    ...
    var decoded = decodeStr.match(/"?[0-9a-f]+"?/g); // match above pattern.
    // note: decoded[0] == 1
    var x_1 = sbr_util_1.padToEven(decoded[1]);
    var x_2 = sbr_util_1.padToEven(decoded[2]);
    var y_1 = sbr_util_1.padToEven(decoded[3]);
    var y_2 = sbr_util_1.padToEven(decoded[4]);
    // convert to buffers.
