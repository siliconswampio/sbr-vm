...
function runCode(opts) {
    ...
    const txContext = (_b = opts.txContext) !== null && _b !== void 0 ? _b : new txContext_1.default((_c = opts.gasPrice) !== null && _c !== void 0 ? _c : new sbr_util_1.BN(0), (_e = (_d = opts.origin) !== null && _d !== void 0 ? _d : opts.caller) !== null && _e !== void 0 ? _e : sbr_util_1.Address.zero());
    const message = (_f = opts.message) !== null && _f !== void 0 ? _f : new message_1.default({
        code: opts.code,
        data: opts.data,
        gasLimit: opts.gasLimit,
        to: (_g = opts.address) !== null && _g !== void 0 ? _g : sbr_util_1.Address.zero(),
        caller: opts.caller,
        value: opts.value,
    ...
    const evm = (_l = opts.evm) !== null && _l !== void 0 ? _l : new evm_1.default(this, txContext, block);
