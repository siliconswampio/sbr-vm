...
function runCall(opts) {
    ...
    const txContext = new txContext_1.default((_b = opts.gasPrice) !== null && _b !== void 0 ? _b : new sbr_util_1.BN(0), (_d = (_c = opts.origin) !== null && _c !== void 0 ? _c : opts.caller) !== null && _d !== void 0 ? _d : sbr_util_1.Address.zero());
